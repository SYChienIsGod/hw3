...
def main():
    ...
    parser.add_option("-o", dest="output", help="output filename of rnnlm model", default="model")
    parser.add_option("--seed", dest="seed", type="int", help="random seed", default=1024)
